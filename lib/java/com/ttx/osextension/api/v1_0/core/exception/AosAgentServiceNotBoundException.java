 ...
 */
public class AosAgentServiceNotBoundException extends AosAgentException {
    ...
    public static final String DESC = "Service not bound";

    public AosAgentServiceNotBoundException() {
        super(CODE, DESC);
    }
}
